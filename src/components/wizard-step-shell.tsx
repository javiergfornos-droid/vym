  ...
  return (
    <main className="mx-auto max-w-4xl px-6 pb-14 pt-28">
      <header className="mb-8 border-b border-line pb-6">
        ...
        <p className="mt-3 max-w-2xl font-editorial text-lg leading-relaxed text-mutedInk">{description}</p>
      </header>
      <section className="rounded-2xl border border-line bg-white p-8 font-editorial shadow-whisper">
        {children}
